...
class AFS_CMB2_Icon_Picker {
	...
	protected function setup_admin_scripts() {
		...
		wp_enqueue_style( 'cmb2-icon-picker',   plugin_dir_url( __FILE__ ) . '/css/icon-picker-admin.css', array(), '1.0' );
	}

}

AFS_CMB2_Icon_Picker::get_instance();
